// Import React & any necessary hooks
...
// Import the function to inject the custom css (we need this to use font-awesome icons)
import { loadCSS } from "fg-loadcss";

// Import the custom svg for the nintendo switch logo
