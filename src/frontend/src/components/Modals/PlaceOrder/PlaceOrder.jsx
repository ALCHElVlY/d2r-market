...
import { D2ItemSuggestions } from "../../../app/structures/index";
        ...
        <div className="pt-3 col-12">
          <div className="row compact widget_order_buttons">
            ...
            <div className="widget_order_season col-12 col-sm-6">
              <div className="form_group">
                <label htmlFor="orderSeason">Ladder / Non&#45;ladder</label>
                <div className="button__group flat">
                  <RadioGroup
                    row
  ...
  const BODY = () => {
    return (
      <Modal
        ...
        <Fade in={open}>
          <Box className="widget_modal" sx={ModelStyle}>
            <ItemImagePreview />
