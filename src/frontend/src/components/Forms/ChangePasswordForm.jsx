...
// Internal imports
import { ChangePasswordConfirm } from "../Buttons/index.js";
import {
  ValidateForm,
  HandleInputFocus,
  HandleFormError,
...
const ChangePasswordForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const inputErrors = Object.entries(error).filter(
      (key) =>
        key.includes("currentPassword") ||
        key.includes("newPassword") ||
  ...
  return (
    <form className="change_password_form" onSubmit={handleSubmit}>
      ...
      <div className="form_group">
        <label htmlFor="cPassword_CurrentPassword">Current password</label>
        <div
      ...
      <div className="form_group">
        ...
        <ul className="form_field_errors" ref={newPasswordError}>
      ...
      <div className="form_group">
        ...
        <ul className="form_field_errors" ref={confirmNewPasswordError}>
          {error.confirmNewPassword && <li>Field required</li>}
        </ul>
      </div>
      <ul className="changePassword_form_errors" ref={formErrors}>
