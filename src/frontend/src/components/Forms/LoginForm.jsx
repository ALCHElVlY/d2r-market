...
const LoginForm = () => {
  ...
  useEffect(() => {
    (async () => {
      HandleInputFocus(isFocused, [emailFocus, passwordFocus]);
    })();
  }, [isFocused]);
    ...
    <div className="col-12 col-lg-6">
      <div className="row py-4">
        ...
        <div className="flex_evenly col-12">
          <Link to="/oauth/bnet">
            <img
              src="assets/images/OAuth-Icons/OAuth_Icon_Blizzard.webp"
              alt="login-blizzard"
            />
          </Link>
          <Link to="#">
            <img
              src="assets/images/OAuth-Icons/OAuth_Icon_Xbox.webp"
              alt="login-xbox"
            />
          </Link>
          <Link to="#">
            <img
              src="assets/images/OAuth-Icons/OAuth_Icon_Discord.webp"
              alt="login-discord"
            />
          </Link>
        </div>
        ...
        <div className="col-12">
          <form onSubmit={handleSubmit}>
            <div className="form_group">
              ...
              <ul className="form_field_errors" ref={emailInputRef}>
            ...
            <div className="form_group">
              ...
              <ul className="form_field_errors" ref={passwordInputRef}>
